...
def create_diashow_and_log(search_term):
    directory = search_term.replace(" ", "_")
    csv_file = f"{search_term}_log.csv"
    html_file = f"{search_term}_slideshow.html"
...
if __name__ == "__main__":
    ...
    download_images(args.search_term, args.num_images)
    create_diashow_and_log(args.search_term)
